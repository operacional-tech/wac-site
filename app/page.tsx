    ...
    <div className="min-h-screen relative" style={{ background: '#1a3a8f' }}>
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          ...
          {[[2,8],[5,22],[8,35],[11,48],[14,62],[17,75],[20,88],
            [23,12],[26,28],[29,42],[32,55],[35,68],[38,82],[41,95],
            [44,5],[47,18],[50,32],[53,45],[56,58],[59,72],[62,85],
            [65,10],[68,25],[71,38],[74,52],[77,65],[80,78],[83,92],
            [86,15],[89,30],[92,42],[95,58],[98,72],
            [3,50],[7,70],[12,20],[16,85],[21,40],[25,60],[30,10],
            [34,78],[39,25],[43,55],[48,80],[52,15],[57,45],[61,70],
            [66,35],[70,90],[75,20],[79,50],[84,75],[88,5],[93,65],
            [1,30],[4,60],[9,90],[13,15],[18,50],[22,75],[27,35],
            [31,65],[36,95],[40,10],[45,40],[49,70],[54,30],[58,60],
            [63,85],[67,15],[72,50],[76,80],[81,10],[85,45],[90,70],
            [94,25],[97,55],[99,85]].map(([x,y], i) => (
            <circle key={`gs${i}`} cx={`${x}%`} cy={`${y}%`} r={0.7 + (i % 3) * 0.5} fill="white" opacity={0.12 + (i % 5) * 0.05} />
          ))}
          {/* Constelações — linhas conectando estrelas */}
          {[[2,8,5,22],[5,22,8,35],[8,35,14,62],[17,75,20,88],
            [23,12,26,28],[26,28,32,55],[35,68,38,82],
            [44,5,47,18],[47,18,53,45],[56,58,59,72],
            [65,10,68,25],[68,25,74,52],[77,65,80,78],
            [86,15,89,30],[89,30,95,58],
            [3,50,7,70],[12,20,16,85],[21,40,25,60],
            [34,78,39,25],[48,80,52,15],[57,45,61,70],
            [70,90,75,20],[79,50,84,75],[88,5,93,65],
            [1,30,4,60],[9,90,13,15],[22,75,27,35],
            [40,10,45,40],[54,30,58,60],[72,50,76,80],
            [85,45,90,70],[94,25,97,55]].map(([x1,y1,x2,y2], i) => (
            <line key={`gl${i}`} x1={`${x1}%`} y1={`${y1}%`} x2={`${x2}%`} y2={`${y2}%`} stroke="white" strokeWidth="0.5" opacity="0.07" />
          ))}
        </svg>
      </div>
      {/* ════════════════════════════════════════════════════════════════ */}
